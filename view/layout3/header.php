...
<head>
  ...
  <title>w3code - Справочник веб-кода, перевод W3Schools | <?php echo $title; ?></title>
  ...
  <nav class="w3-bar w3-top w3-dark-gray" >
   <!-- button open left sidebar-->
    <button class="w3-bar-item w3-button w3-light-gray  w3-hide-large" onclick="openLeftSidebar()">&#9776;</button> 
      <a href="<?php echo BASE_URL; ?>index.php" class="w3-bar-item w3-button w3-light-green" style="font-weight:bold;" >w3code</a>
<?php 
